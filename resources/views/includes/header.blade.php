<div class="header-div section">
    ...
    <div style="flex-grow:12;margin-left:35px;">User Dashboard</div>
    ...
    <div id="myDropdown" class="dropdown-content">Filters
    ...
    <div class="search-div" style="flex-grow:1;">
        <div><span><i class="fa-light fa-magnifying-glass"></i></span><input class="name-input" type="text" placeholder="Search" name="search"/></div>
    </div>
</div>